...
and face recognition here: http://docs.opencv.org/modules/contrib/doc/facerec/facerec_tutorial.html
...
import fnmatch # Include for file directory iteration
import os # Include os in order to enable Terminal-Based commands.

import cv2 # Include OPENCV 3.0.0 library
import numpy as np # Include for Scientific Computing
